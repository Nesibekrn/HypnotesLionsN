...
Feature: Features section functionality in footer by the homepage
  ...
  @US_010  @UI
  Scenario: Verify that  BiofeedbackEmotion-Detection page  in the feature section is opened when the user clicks on the Biofeedback/Emotion-Detection in the footer section
