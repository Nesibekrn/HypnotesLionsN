Feature: US060-TC001-Update Company information

	Background:


	#{color:#ff5630}*US:*{color}
	#
	#As a user (Therapist), I should be able to perform various actions in the Profile(Your Company) section
	#
	#{color:#ff5630}*AC:*{color}
	#
	#Your Company
	#
	...
	@TEST_HL-381
	Scenario: US060-TC001-Update Company information
